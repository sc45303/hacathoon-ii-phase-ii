...
import { navItemVariants, buttonVariants, staggerContainer, staggerItem } from '@/lib/animations';
              ...
              >
                <motion.div
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-gray-100 dark:bg-gray-800 text-todoist-red font-semibold'
                ...
                >
                  ...
                  {!isCollapsed && (
                    <>
                      <span className="flex-1 leading-normal">{item.label}</span>
